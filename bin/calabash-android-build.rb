def calabash_build(app)
  ...
  Dir.mktmpdir do |workspace_dir|
    Dir.chdir(workspace_dir) do
      ...
      unless system %Q{"#{Env.tools_dir}/aapt" package -M AndroidManifest.xml  -I "#{android_platform.gsub("/cygdrive/c", "C:")}/android.jar" -F dummy.apk}
    ...
    keystore.sign_apk("C:/cygwin#{workspace_dir}/TestServer.apk", test_server_file_name)
    begin
